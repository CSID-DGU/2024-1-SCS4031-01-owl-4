...
const LoginButton = () => {
  ...
  return (
    ...
    <Link to="login" className="w-[100px] h-[50px] relative bg-[#222] text-center leading-[50px] text-white overflow-hidden group 
    after:absolute after:top-[var(--y)] after:left-[var(--x)] after:translate-x-[-50%] after:translate-y-[-50%] after:w-0 after:h-0 after:bg-green-400 after:rounded-full
    after:ease-out after:duration-[0.5s] hover:after:w-[300px] hover:after:h-[300px]" onMouseOver={handleMouseOver}>
      ...
      <p className='relative tracking-wider pointer-events-none transition-opacity duration-[0.4s] delay-[0.15s]
      group-hover:opacity-0 group-hover:transition-opacity group-hover:duration-[0.4s]'>Login</p>
    </Link>
  )
}
