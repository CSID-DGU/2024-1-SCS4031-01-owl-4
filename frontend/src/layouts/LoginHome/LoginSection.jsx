            ...
            <main className='relative w-2/5 m-auto px-6 text-gray-500 bg-white rounded-xl shadow-xl'>
                <div className="p-6 mt-10">
                    ...
                    <div className='mt-16 grid space-y-4 gap-2'>
                        <button onClick={handleGoogleLogin} className='group flex justify-center h-14 px-3 border-2 border-gray-300 rounded-full transition duration-300 hover:border-blue-400 focus:bg-blue-50 active:bg-blue-100'>
                            <div className='relative w-full h-full flex items-center space-x-4 justify-center'>
                        ...
                        <button onClick={handleKakaoLogin} className='group flex justify-center h-14 px-3 border-2 border-gray-300 rounded-full transition duration-300 hover:border-blue-400 focus:bg-blue-50 active:bg-blue-100'>
                            <div className='relative w-full h-full flex items-center space-x-4 justify-center'>
                                <img src={kakao} alt="google logo" className=' absolute left-0 size-10' />
                                <span className='block w-max font-semibold tracking-wide text-gray-700 text-sm transition duration-300 group-hover:text-blue-600'>Continue with Kakao</span>
                            </div>
                        </button>
                        <button onClick={handleNaverLogin} className='group flex justify-center h-14 px-3 border-2 border-gray-300 rounded-full transition duration-300 hover:border-blue-400 focus:bg-blue-50 active:bg-blue-100'>
                            <div className='relative w-full h-full flex items-center space-x-4 justify-center'>
                                <img src={naver} alt="google logo" className=' absolute left-0 size-10' />
                                <span className='block w-max font-semibold tracking-wide text-gray-700 text-sm transition duration-300 group-hover:text-blue-600'>Continue with Naver</span>
                            </div>
                        </button>
                    </div>
